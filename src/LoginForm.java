...
public class LoginForm extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/vols","root","");
            Statement stmt = con.createStatement();
            
            String sql ="Select * from utilisateur where login='"+txtUser.getText()+"' and password='"+txtPassword.getText().toString()+"'";  
            ...
            if(rs.next()){
                if(rs.getString("opt").equals("admin")){
                    Admin Admin ;
                    Admin = new Admin ();
